...
//投注等级
const levelData = ref([
  {levelName: '1A', levelCost: 20}, {levelName: '1B', levelCost: 20}, {
    levelName: '1C',
    levelCost: 20
  }, {levelName: '1D', levelCost: 20}, {levelName: '1E', levelCost: 20},
  {levelName: '2A', levelCost: 25}, {levelName: '2B', levelCost: 25}, {
    levelName: '2C',
    levelCost: 25
  }, {levelName: '2D', levelCost: 25}, {levelName: '2E', levelCost: 25},
  {levelName: '3A', levelCost: 30}, {levelName: '3B', levelCost: 30}, {
    levelName: '3C',
    levelCost: 30
  }, {levelName: '3D', levelCost: 30}, {levelName: '3E', levelCost: 30},
  {levelName: '4A', levelCost: 35}, {levelName: '4B', levelCost: 35}, {
    levelName: '4C',
    levelCost: 35
  }, {levelName: '4D', levelCost: 35}, {levelName: '4E', levelCost: 35},
  {levelName: '5A', levelCost: 40}, {levelName: '5B', levelCost: 40}, {
    levelName: '5C',
    levelCost: 40
  }, {levelName: '5D', levelCost: 40}, {levelName: '5E', levelCost: 40},
  {levelName: '6A', levelCost: 45}, {levelName: '6B', levelCost: 45}, {
    levelName: '6C',
    levelCost: 45
  }, {levelName: '6D', levelCost: 45}, {levelName: '6E', levelCost: 45},
  {levelName: '7A', levelCost: 50}, {levelName: '7B', levelCost: 50}, {
    levelName: '7C',
    levelCost: 50
  }, {levelName: '7D', levelCost: 50}, {levelName: '7E', levelCost: 50},
  {levelName: '8A', levelCost: 55}, {levelName: '8B', levelCost: 55}, {
    levelName: '8C',
    levelCost: 55
  }, {levelName: '8D', levelCost: 55}, {levelName: '8E', levelCost: 55},
  {levelName: '9A', levelCost: 60}, {levelName: '9B', levelCost: 60}, {
    levelName: '9C',
    levelCost: 60
  }, {levelName: '9D', levelCost: 60}, {levelName: '9E', levelCost: 60},
  {levelName: '10A', levelCost: 65}, {levelName: '10B', levelCost: 65}, {
    levelName: '10C',
    levelCost: 65
  }, {levelName: '10D', levelCost: 65}, {levelName: '10E', levelCost: 65},
  {levelName: '11A', levelCost: 70}, {levelName: '11B', levelCost: 70}, {
    levelName: '11C',
    levelCost: 70
  }, {levelName: '11D', levelCost: 70}, {levelName: '11E', levelCost: 70},
  {levelName: '12A', levelCost: 75}, {levelName: '12B', levelCost: 75}, {
    levelName: '12C',
    levelCost: 75
  }, {levelName: '12D', levelCost: 75}, {levelName: '12E', levelCost: 75},
  {levelName: '13A', levelCost: 80}, {levelName: '13B', levelCost: 80}, {
    levelName: '13C',
    levelCost: 80
  }, {levelName: '13D', levelCost: 80}, {levelName: '13E', levelCost: 80},
  {levelName: '14A', levelCost: 85}, {levelName: '14B', levelCost: 85}, {
    levelName: '14C',
    levelCost: 85
  }, {levelName: '14D', levelCost: 85}, {levelName: '14E', levelCost: 85},
  {levelName: '15A', levelCost: 90}, {levelName: '15B', levelCost: 90}, {
    levelName: '15C',
    levelCost: 90
  }, {levelName: '15D', levelCost: 90}, {levelName: '15E', levelCost: 90},
  {levelName: '16A', levelCost: 95}, {levelName: '16B', levelCost: 95}, {
    levelName: '16C',
    levelCost: 95
  }, {levelName: '16D', levelCost: 95}, {levelName: '16E', levelCost: 95},
  {levelName: '17A', levelCost: 100}, {levelName: '17B', levelCost: 100}, {
    levelName: '17C',
    levelCost: 100
  }, {levelName: '17D', levelCost: 100}, {levelName: '17E', levelCost: 100},
  {levelName: '18A', levelCost: 110}, {levelName: '18B', levelCost: 110}, {
    levelName: '18C',
    levelCost: 110
  }, {levelName: '18D', levelCost: 110}, {levelName: '18E', levelCost: 110},
  {levelName: '19A', levelCost: 120}, {levelName: '19B', levelCost: 120}, {
    levelName: '19C',
    levelCost: 120
  }, {levelName: '19D', levelCost: 120}, {levelName: '19E', levelCost: 120},
  {levelName: '20A', levelCost: 130}, {levelName: '20B', levelCost: 130}, {
    levelName: '20C',
    levelCost: 130
  }, {levelName: '20D', levelCost: 130}, {levelName: '20E', levelCost: 130},
  {levelName: '21A', levelCost: 140}, {levelName: '21B', levelCost: 140}, {
    levelName: '21C',
    levelCost: 140
  }, {levelName: '21D', levelCost: 140}, {levelName: '21E', levelCost: 140},
  {levelName: '22A', levelCost: 150}, {levelName: '22B', levelCost: 150}, {
    levelName: '22C',
    levelCost: 150
  }, {levelName: '22D', levelCost: 150}, {levelName: '22E', levelCost: 150},
  {levelName: '23A', levelCost: 160}, {levelName: '23B', levelCost: 160}, {
    levelName: '23C',
    levelCost: 160
  }, {levelName: '23D', levelCost: 160}, {levelName: '23E', levelCost: 160},
  {levelName: '24A', levelCost: 170}, {levelName: '24B', levelCost: 170}, {
    levelName: '24C',
    levelCost: 170
  }, {levelName: '24D', levelCost: 170}, {levelName: '24E', levelCost: 170},
  {levelName: '25A', levelCost: 180}, {levelName: '25B', levelCost: 180}, {
    levelName: '25C',
    levelCost: 180
  }, {levelName: '25D', levelCost: 180}, {levelName: '25E', levelCost: 180},
  {levelName: '26A', levelCost: 190}, {levelName: '26B', levelCost: 190}, {
    levelName: '26C',
    levelCost: 190
  }, {levelName: '26D', levelCost: 190}, {levelName: '26E', levelCost: 190},
  {levelName: '27A', levelCost: 200}, {levelName: '27B', levelCost: 200}, {
    levelName: '27C',
    levelCost: 200
  }, {levelName: '27D', levelCost: 200}, {levelName: '27E', levelCost: 200}
]);
...
const makeRecord = (times, levelName, levelCost, buyDetail, openDetail, result, moneyGet, momeyRemain) => {
  currentGambleRecords.value.unshift({
    times, levelName, levelCost, result, buyDetail, openDetail, moneyGet, momeyRemain, levelUp: 0
  })
...
//赢局
const win = (open) => {
  const moneyGet = levelData.value[currentLevelIndex.value].levelCost + levelData.value[currentLevelIndex.value].levelCost * 0.95
  const momeyRemain = totalMoney.value + (moneyGet)
  totalMoney.value = momeyRemain
  makeRecord(currentGambleNumber.value, levelData.value[currentLevelIndex.value].levelName, levelData.value[currentLevelIndex.value].levelCost, getBuyDetail(), getOpenDetail(open), '赢', moneyGet, momeyRemain)
  winCount.value++
  loseCount.value = 0
}
//和局
const tie = (open) => {
  ...
  const momeyRemain = totalMoney.value + (moneyGet)
  totalMoney.value = momeyRemain
  makeRecord(currentGambleNumber.value, levelData.value[currentLevelIndex.value].levelName, levelData.value[currentLevelIndex.value].levelCost, getBuyDetail(), getOpenDetail(open), '和', moneyGet, momeyRemain)
  loseCount.value++
  winCount.value = 0
}
//输局
...
const lose = (open) => {
  ...
  const momeyRemain = totalMoney.value + (moneyGet)
  totalMoney.value = momeyRemain
  makeRecord(currentGambleNumber.value, levelData.value[currentLevelIndex.value].levelName, levelData.value[currentLevelIndex.value].levelCost, getBuyDetail(), getOpenDetail(open), '输', moneyGet, momeyRemain)
  loseCount.value++
  winCount.value = 0
}
...
//开始游戏
const gameStart = () => {
  const result = getRandomOne()
  if (currentBuy.value === result) {
    win(result)
  } else {
